package com.projetos.barbearia.Activity // Pacote onde a classe está localizada
...
import com.projetos.barbearia.R // Importa os recursos do projeto, como layouts e strings
import com.projetos.barbearia.databinding.ActivityEscolhaServicoBinding // Importa o binding gerado automaticamente para acessar elementos do layout
import com.projetos.barbearia.viewmodel.EscolhaServicoViewModel // Importa o ViewModel associado a esta atividade
...
class EscolhaServicoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.servicosRadioGroup.setOnCheckedChangeListener { _, checkedId ->
            when (checkedId) {
