...
import com.projetos.barbearia.Repository.EscolhaServicoRepository // Importa o repositório que fornece dados de barbearias ou serviços

// Classe ViewModel que gerencia os dados para a tela de escolha de serviço
class EscolhaServicoViewModel : ViewModel() {
    private val repository = EscolhaServicoRepository() // Instância do repositório para fornecer dados
